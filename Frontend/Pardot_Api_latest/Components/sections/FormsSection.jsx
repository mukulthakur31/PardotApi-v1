      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            💡 Shows only forms with activities in selected period
          </div>
        </div>
      </div>
                ...
                return (
                  ...
                  onMouseOut={(e) => {
                    ...
                    <td style={{ 
                      padding: "10px 8px", 
                      textAlign: "center", 
                      color: form.last_activity ? "#94a3b8" : "#64748b", 
                      fontSize: "0.8rem",
                      fontStyle: form.last_activity ? "normal" : "italic"
                    }}>
                      {form.last_activity ? formatDate(form.last_activity) : "No activity"}
                    </td>
                  </tr>
                );
              })}
